...
// prettier-ignore
const helpMessage = `\
Usage: create-scratch-extension [OPTION]... [DIRECTORY]

Create a new Scratch extension in JavaScript or TypeScript.
When running in TTY, the CLI will start in interactive mode.

Options:
  -t, --template NAME                   use a specific template
  -i, --immediate                       install dependencies
  --overwrite                           remove existing files
  --interactive / --no-interactive      force interactive / non-interactive mode

Available templates:
${c.red ('turbowarp-ts     turbowarp-js')}
${c.cyan('penguinmod-ts    penguinmod-js')}`
...
async function main() {
  ...
  prompts.intro(c.inverse(c.cyan(` create-scratch-extension `)));
  ...
  const defaultTargetDir = 'extension';
  ...
  doneMessage += c.inverse(c.magentaBright(` You're all set! Now run: \n`));
  ...
  doneMessage += `\n  ${getRunCommand(pkgManager, 'watch').join(' ')}`;
